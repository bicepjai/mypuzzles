...
import java.io.*;
 ...
 public class suffixtreeq {
	 public static void main(String[] args) {
		 String testString = "mississippi";
		 String[] stringList = {"is", "sip", "hi", "sis"};
		 SuffixTree tree = new SuffixTree(testString);
		//Enumeration keys = tree.root.children.keys();
		System.out.println(tree.root.children.keySet());
		System.out.println(tree.root.indexes);
			//System.out.println(tree.getClass().getName());
			//System.out.println(tree.root.getClass().getName());
			//System.out.println(tree.root.children.getClass().getName());
